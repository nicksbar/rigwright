//! Icom IC-756PROII CI-V profile.
//!
//! Command and address data is taken from the IC-756PROII instruction manual
//! extraction in the workspace `_manuals/IC-756PROII.md`.
...
pub const CIV_PROFILE: IcomCivProfile = IcomCivProfile {
    model: crate::models::IcomCivModel::Ic756ProIi,
...
mod tests {
    ...
    fn profile_matches_manual_identity_and_legacy_commands() {
        assert_eq!(profile().model, "IC-756PROII");
